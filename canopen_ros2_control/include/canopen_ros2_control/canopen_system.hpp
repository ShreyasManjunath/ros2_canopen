  ...
  void set_co_data_type(const std::string & type)
  {
    ...
    else
    {
      RCLCPP_WARN(
        ...
        "double. This might cause errornous data! Please contribute or by maintainers a cookie and "
  ...
  void prepare_data()
  {
    ...
    else
    {
      RCLCPP_WARN(
        ...
        "errornous data! Please contribute or by maintainers a cookie and hope they implement it "
        "for you!",
        co_type.c_str());
...
protected:
  ...
  // can stuff
  std::unordered_map<std::pair<uint16_t, uint16_t>, CanopenNodeData, pair_hash> canopen_data_;
  // threads
